...
<div id="overlay" onclick="hideOverlay()"><div id="overlay-content"><p>To adjust the fontsize and other display settings click the circular button in the lower right corner. Do <b>not</b> use Google Chrome's "Simplified View" instead. Also, please disable any dark mode extensions such as Dark Reader on this domain.<br><br>Thanks!</p></div></div>
